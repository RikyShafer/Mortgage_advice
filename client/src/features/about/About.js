        ...
        <div className="about">
            ...
            <div className='Our-story'>
                ...
                <div className='Our-story2'>
                    <p>
                        לחבר טקסט על הסיפור של המשרד, איך נפתח וכ א א א אר כ ג ד  עכג דעכ
                        טיעמכג נהבההההה הההההההה
                    </p>
                </div>
                <div className='Our-story3'>
                    <p>
                        לחבר טקסט על הסיפור של המשרד, איך נפתח וכו
                        טיעמכג נהבהההה ההההההההה </p>
                </div>
            </div>
